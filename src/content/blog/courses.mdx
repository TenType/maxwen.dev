...
| Course                                            | Units |       Difficulty       |        Workload        |
| ------------------------------------------------- | :---: | :--------------------: | :--------------------: |
| 15-150 Principles of Functional Programming       |  12   | <LevelBar level={2} /> | <LevelBar level={3} /> |
| 21-241 Matrices and Linear Transformations        |  11   | <LevelBar level={2} /> | <LevelBar level={2} /> |
...
| 79-160 Introduction to the History of Science     |   9   | <LevelBar level={1} /> | <LevelBar level={2} /> |
| 85-110 Cognitive Psychology                       |   9   | <LevelBar level={1} /> | <LevelBar level={1} /> |
